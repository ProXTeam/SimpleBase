...
/*struct Constants {
    struct UrlSchemeServer {
        static let BaseUrl = "http://news.startv.vn"
    }
}*/
...
public let UrlSchemeServerBaseUrl = "http://news.startv.vn"
...
//UserDefault
public let NSKeyUserDefaultArrCateObj = "menuCateObj"
